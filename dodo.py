    ...
    def index_html():
        ...
        with open(docs / 'index.html', 'w') as f:
            content = div.content[
                ...
                div.desc[
                    p[
                        span[f'מעל ל-{len(ns) * r - 1} תשבצים בגדלים שונים להורדה חופשית. התשבצים נוצרו באופן אוטומטי, ההגדרות לתשבצים נלקחו מ-'],
                        ...
                        a(href='https://github.com/gkutiel/wikicross', target='_blank')['כאן'],
                        span['.'],
                    ]
                ]
            ]
